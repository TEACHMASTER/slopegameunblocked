                ...
                <div className="pt-16 md:pt-10">
                    <div className="relative">
                        ...
                        <div className="absolute top-0 -mt-4 left-1/2 -translate-x-1/2 pointer-events-none -z-10 hidden md:block" aria-hidden="true">
                            <svg xmlns="http://www.w3.org/2000/svg" width="1270" height="383">
                        ...
                        <div className="py-12 md:py-20 -mx-20 px-20">
                            <div className="max-w-3xl mx-auto text-center">
                                <h2 className="font-hkgrotesk text-6xl !text-slate-100 mb-12">
                                    { t('desc')}
                                ...
                                <div className="-m-1.5 max-w-xl mx-auto mb-8">
                                    <button className="btn text-white bg-blue-500 hover:bg-blue-600 group shadow-sm m-1.5">{t('k1')}</button>
                                    <button className="btn text-white bg-blue-500 hover:bg-blue-600 group shadow-sm m-1.5">{t('k2')}</button>
                                    <button className="btn text-white bg-blue-500 hover:bg-blue-600 group shadow-sm m-1.5">{t('k3')}</button>
                                    <button className="btn text-white bg-blue-500 hover:bg-blue-600 group shadow-sm m-1.5">{t('k4')}</button>
                                </div>
