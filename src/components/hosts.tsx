...
import Host01 from '@/public/images/host-01.png'
    ...
    <section>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="relative">
          {/* Background */}
          <div className="absolute inset-0 bg-slate-900 rounded-3xl -mx-20 -z-10" aria-hidden="true">
            {' '}
          </div>

          {/* Sparkles */}
          <div className="absolute top-0 left-1/2 -translate-x-1/2 mt-14 pointer-events-none -z-10 hidden lg:block" aria-hidden="true">
          ...
          {/* Scratches */}
          <div className="absolute top-full left-1/2 -translate-x-1/2 -mt-4 pointer-events-none -z-10" aria-hidden="true">
          ...
          <div className="py-12 md:py-20 -mx-20 px-20 overflow-hidden">
            <div className="lg:flex items-start">
              ...
              <div className="flex-1 mb-12 lg:mb-0">
                <div className="mb-6">
                  <h2 className="text-3xl md:text-4xl font-hkgrotesk font-extrabold text-slate-100 mb-2">Meet Your Hosts</h2>
                  <div className="text-slate-400 space-y-3">
                    <p>
                      There are many variations of passages of lorem available, but the majority have suffered alteration in some form by injected
                      humour.
                    </p>
                    <p className="italic">
                      'Latin words, combined with a handful of model sentence structures, to generate which looks reasonable. The generated is
              ...
              <div className="lg:w-[640px] lg:ml-12 xl:ml-20">
                <div className="space-y-12 lg:space-y-20">
                  ...
                  <div className="flex items-start">
                    <Image className="mr-6" src={Host01} width={153} height={130} alt="Host 01" />
                    <div>
                      <div className="text-lg font-hkgrotesk font-extrabold text-slate-100">Samantha James</div>
                      <div className="mb-2">
                        <a className="font-hkgrotesk font-medium text-sm text-blue-500 hover:underline" href="#0">
                          @samyjames
                        </a>
                      </div>
                      <div className="text-slate-400">
                        Samantha is a startup founder who loves to learn from successful makers and teach others how they can achieve similar success.
                      </div>
                    </div>
                  </div>
                  {/* Host */}
                  <div className="flex items-start">
                    <Image className="mr-6" src={Host02} width={153} height={130} alt="Host 02" />
                    <div>
                      <div className="text-lg font-hkgrotesk font-extrabold text-slate-100">Quentin Villard</div>
                      <div className="mb-2">
                        <a className="font-hkgrotesk font-medium text-sm text-blue-500 hover:underline" href="#0">
                          @quentin789
                        </a>
                      ...
                      <div className="text-slate-400">
                        Quentin is a startup founder who loves to learn from successful makers and teach others how they can achieve similar success.
                      </div>
                    </div>
                  </div>
                  {/* Host */}
                  <div className="flex items-start">
                    <Image className="mr-6" src={Host03} width={153} height={130} alt="Host 03" />
                    <div>
                      <div className="text-lg font-hkgrotesk font-extrabold text-slate-100">Natascha Patrick</div>
                      <div className="mb-2">
                        <a className="font-hkgrotesk font-medium text-sm text-blue-500 hover:underline" href="#0">
                          @natypaty88
                        </a>
                      ...
                      <div className="text-slate-400">
                        Natascha is a startup founder who loves to learn from successful makers and teach others how they can achieve similar success.
                      </div>
                    </div>
                  </div>
                </div>
